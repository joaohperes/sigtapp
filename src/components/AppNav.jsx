    ...
    <nav className={cn(
      ...
      <div className="mx-auto flex max-w-7xl items-center gap-2 px-4 py-2 sm:px-6">
        ...
        <button
          ...
          className={cn(
            'flex items-center gap-2 text-sm font-semibold tracking-widest transition font-mono',
        ...
        <div className="flex items-center gap-0.5">
          ...
          <NavLink to="/mapa" label="Mapa" active={location.pathname === '/mapa'} modoUE={modoUE} dark={dark} />
