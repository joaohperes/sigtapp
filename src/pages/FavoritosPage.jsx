        ...
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <h1 className={cn("text-xl font-bold", modoUE ? "text-white" : "text-foreground")}>Favoritos</h1>
              <span className={cn("text-sm", modoUE ? "text-red-300" : "text-muted-foreground")}>
      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
        {favoritos.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 gap-3 text-center">
            <svg className="h-12 w-12 text-muted-foreground/20" stroke="currentColor" fill="none" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
                d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
            </svg>
            <p className="text-sm text-muted-foreground">Nenhum procedimento favoritado ainda.</p>
